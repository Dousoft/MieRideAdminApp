...
class InteracTransferCard extends StatelessWidget {
  ...
  final controller = Get.find<InteracTransferController>();
  final RxBool isUpdating = false.obs;

  @override
  Widget build(BuildContext context) {
    final Map<String, dynamic>? user = transaction['user'];

    final dateStr = transaction['created_date'] ?? '';
    final timeStr = transaction['created_time'] ?? '';
    ...
    final String status = transaction['status'] ?? '0';
                  ...
                  Row(
                    children: [
                      ...
                      if ((transaction['image'] ?? '').toString().isNotEmpty)
                        ...
                        Text("N/A", style: TextStyle(fontSize: 13.sp)),
                    ],
                  ),
                ],
              )),
